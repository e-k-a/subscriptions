...
from src.schemas.schemas import PaymentCreate, PaymentResponse, PaymentMethodResponse
...
async def create_payment(
    db: AsyncSession, user_id: int, amount: float, subscription_id: Optional[int] = None
):
